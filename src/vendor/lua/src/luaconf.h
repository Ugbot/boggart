...
*/
/* boggart: OFF. `global` is a reserved word in 5.5; we renamed our own helper
   to `declare` rather than lean on a compatibility option the manual says will
   be removed. Leaving this off means a missed call site is a compile error now
