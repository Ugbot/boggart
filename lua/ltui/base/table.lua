...
-- boggart: was 'table.unpack = unpack'. The global `unpack` was removed in Lua
-- 5.2, so on our vendored 5.4 that assigned nil and destroyed the *stock*
-- table.unpack process-wide. Keep the real one; only fall back on 5.1, and
-- read the global with rawget so strict.lua does not reject it.
